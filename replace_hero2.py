...
new_hero = """const VideoHero = () => {
  ...
  return (
    ...
    >
      ...
      <div className="w-full lg:w-[45%] xl:w-[45%] flex-shrink-0 relative z-20 flex flex-col justify-center px-6 md:px-10 lg:px-16 pt-32 pb-20 border-r-0 lg:border-r-[2px] border-white/10 bg-[#050505]">
        ...
        <div className="relative z-10 max-w-2xl">
          ...
          >
            <div className="inline-flex items-center gap-3 px-4 py-2 border-[2px] border-brand/40 bg-brand/5 shadow-[4px_4px_0px_0px_rgba(255,69,0,0.2)]">
              ...
              <span className="font-mono text-[10px] tracking-[0.25em] font-bold uppercase text-brand">
          ...
          <div className="mb-10 flex flex-col gap-1">
            <motion.h1
              ...
              className="font-black uppercase tracking-tighter text-white leading-[0.85] text-[clamp(3.5rem,6vw,6rem)]"
            >
              Simulate
            </motion.h1>
            <motion.h1
            ...
            <motion.h1
              ...
              className="font-black uppercase tracking-tighter text-white leading-[0.85] text-[clamp(3.5rem,6vw,6rem)] mt-2"
            >
              Before You
            </motion.h1>
            <motion.h1
          ...
          <motion.p
            ...
            className="text-sm md:text-base font-semibold text-white/70 max-w-[44ch] leading-relaxed mb-10 pl-5 border-l-[4px] border-brand bg-white/5 py-4 pr-4"
          >
          ...
          >
            <a
              ...
              className="inline-flex items-center gap-3 px-6 py-3.5 bg-brand text-black font-mono font-black text-xs tracking-widest uppercase border-[3px] border-brand hover:-translate-y-1 hover:-translate-x-1 shadow-[5px_5px_0px_0px_rgba(255,255,255,0.15)] hover:shadow-none transition-all"
            >
              <IconBolt size={16} stroke={2.5} />
              Run Simulation
            </a>
            <a
              href="#capabilities"
              className="inline-flex items-center gap-3 px-6 py-3.5 bg-transparent text-white font-mono font-bold text-xs tracking-widest uppercase border-[3px] border-white/20 hover:border-brand hover:text-brand transition-colors"
            >
      ...
      <div className="w-full lg:w-[55%] xl:w-[55%] relative min-h-[50vh] lg:min-h-full bg-black overflow-hidden group border-t-[2px] lg:border-t-0 border-white/10 flex flex-col">
        ...
        <video
          ...
          className={`absolute inset-0 w-full h-full object-cover object-center filter contrast-[1.1] brightness-[0.9] transition-transform duration-1000 ease-out group-hover:scale-105 ${isVideoLoaded ? "opacity-100" : "opacity-0"}`}
        >
          <source src="/Untitled design (1).mp4" type="video/mp4" />
        </video>

        {/* Brutalist Dot Grid Texture over Video - Lighter now */}
        <div
        ...
        <div className="absolute bottom-6 right-6 lg:bottom-10 lg:right-10 z-20 flex items-end gap-6">
          <div className="flex gap-2">
            <button
              onClick={togglePlay}
              className="w-12 h-12 bg-black/40 backdrop-blur-md border-[2px] border-white/20 text-white flex items-center justify-center hover:border-brand hover:text-brand transition-colors hover:bg-black/80"
            >
...
print("Replaced VideoHero with wider video successfully.")
